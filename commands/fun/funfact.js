module.exports = {
    commands: ['funfact', 'tellmeafact'],
    description: 'Tells a fun fact!',
    callback: (message) => {
        const funFacts = [
            ...
            'SPECIAL: Daniel Radcliffe was allergic to his Harry Potter glasses.',
            ...
            'SPECIAL: If you point your car keys to your head, it increases the remote’s signal range.',
            ...
            'SPECIAL: The world’s largest grand piano was built by a 15-year-old in New Zealand.',
            ...
            '(I find this one funny lol) There is a boss in Metal Gear Solid 3 that can be defeated by not playing the game for a week; or by changing the date.',
            ...
            'SPECIAL: German Chocolate Cake is named after an American baker by the name of Samuel German.',
            ...
            'SPECIAL: Apple paid a couple $1.7 million dollars for their plot of land, which was only worth $181,700.',
            ...
            'SPECIAL: There were only 9 developers on the team for GoldenEye 007 for Nintendo 64.',
            ...
            '(Funny) People who post their fitness routine on Facebook are more likely to have psychological problems.',
            ...
            'SPECIAL: There is an underwater version of rugby, unsurprisingly called “underwater rugby”.',
            ...
            'SPECIAL: When mice live in the wild, they typically only live for about six months.',
            ...
            'SPECIAL: Saint Lucia is the only country in the world named after a woman.',
            ...
            'SPECIAL: To properly write adjectives in order, you would list them by amount, value, size, temperature, age, shape, color, origin, and material.'
        ]
        message.channel.send(funFacts[Math.floor(Math.random() * funFacts.length)])
    }
}